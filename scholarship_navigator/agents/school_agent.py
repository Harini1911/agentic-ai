...
school_agent = Agent(
    name="SchoolScholarshipAgent",
    model="gemini-2.5-flash",
    description="Specialized agent for school scholarships. Handles Class 6 to Class 12 levels.",
    instruction="""
You are the SchoolScholarshipAgent, a specialized scholarship consultant for school students (Class 6 to Class 12).
