...
ug_agent = Agent(
    name="UGScholarshipAgent",
    model="gemini-2.5-flash",
    description="Specialized agent for undergraduate scholarships. Handles B.E., B.Tech., B.Sc., BA, B.Com. degrees.",
    instruction="""
You are the UGScholarshipAgent, a specialized scholarship consultant for undergraduate students (e.g., B.E., B.Tech., B.Sc., BA, B.Com.).
